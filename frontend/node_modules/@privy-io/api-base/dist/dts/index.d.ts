...
declare enum PrivyErrorCode {
    ...
    /** The Solana transaction could not be deserialized */
    INVALID_SOLANA_TRANSACTION = "invalid_solana_transaction",
    ...
    /** Operation blocked for compliance reasons. */
    COMPLIANCE_BLOCKED = "compliance_blocked",
    /** Invalid request */
    INVALID_REQUEST = "invalid_request",
    /** User sign ups are suspended for this account. */
    SIGNUP_DISABLED = "signup_disabled",
    /** The resource exists but is not in a valid state for this operation. */
...
export { APIError, AccountTransferRequiredError, AllowlistRejectedError, ForbiddenError, HttpError, InsufficientBalanceError, InternalServerError, InvalidInputError, LegacyInvalidInputError, NotFoundError, PaymentFailedError, PrivyErrorCode, RequestTimeoutError, ResourceConflictError, TooManyRequestsError, UnauthorizedError, UnsupportedMediaType };
