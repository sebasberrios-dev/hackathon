...
export declare class Wallets extends APIResource {
     ...
     * ```
     */
    _export(walletID: string, params: WalletExportParams, options?: RequestOptions): APIPromise<WalletExportResponseBody>;
    /**
