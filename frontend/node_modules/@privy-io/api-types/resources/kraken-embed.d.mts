...
export interface KrakenEmbedGetAssetListQueryParamsSchema {
    ...
    'filter[platform_statuses]'?: Array<'enabled' | 'deposit_only' | 'withdrawal_only' | 'funding_temporarily_disabled' | 'disabled' | (string & {})>;
...
export declare namespace KrakenEmbedGetPortfolioTransactionsQueryParamsSchema {
    interface RefID {
        ref_id: string;
