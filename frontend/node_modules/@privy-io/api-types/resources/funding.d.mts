...
import * as FundingAPI from "./funding.mjs";
 ...
 */
export type MoonpayOnRampSignInput = MoonpayOnRampSignInput.MoonpayFiatOnRampEthereumInput | MoonpayOnRampSignInput.MoonpayFiatOnRampSolanaInput;
export declare namespace MoonpayOnRampSignInput {
    /**
     * Sandbox configuration for a Moonpay on-ramp.
     */
    interface MoonpayFiatOnRampEthereumInput extends FundingAPI.MoonpayOnRampSandboxConfig, FundingAPI.MoonpayFiatOnRampEthereumInput {
    }
    /**
     * Sandbox configuration for a Moonpay on-ramp.
     */
    interface MoonpayFiatOnRampSolanaInput extends FundingAPI.MoonpayOnRampSandboxConfig, FundingAPI.MoonpayFiatOnRampSolanaInput {
    }
}
/**
 ...
 */
export type CoinbaseBlockchain = 'ethereum' | 'bitcoin' | 'base' | 'avacchain' | 'optimism' | 'solana' | 'polygon' | 'arbitrum' | 'stellar' | 'monad';
/**
 ...
 * A payment method supported by Moonpay on-ramp.
 */
export type MoonpayPaymentMethod = 'ach_bank_transfer' | 'credit_debit_card' | 'gbp_bank_transfer' | 'gbp_open_banking_payment' | 'mobile_wallet' | 'sepa_bank_transfer' | 'sepa_open_banking_payment' | 'pix_instant_payment' | 'yellow_card_bank_transfer';
/**
 * A Moonpay currency code for a Solana asset.
 */
