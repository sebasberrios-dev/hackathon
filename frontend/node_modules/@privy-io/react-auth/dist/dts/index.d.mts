import { l as MfaSubmitArgs, c as UserRecoveryMethod, g as SessionSignerInput, E as EthereumRpcRequestType, m as SolanaRpcRequestType, n as EthereumRpcResponseType, o as SolanaRpcResponseType, p as PrivyFarcasterSignerInitResponse, q as EIP1193Provider, r as EntropyIdVerifier$1, H as HDWalletWithMetadata, s as RequestArguments, u as WalletConnector, B as BaseConnectedEthereumWallet, v as PrivyProxyProvider, w as WalletClientType, x as ConnectedWalletMetadata, y as PrivyClientConfig, z as SetBaseAccountSdkType, A as WalletListEntry, D as AppConfig, G as BaseConnectedWallet, I as ConnectorType, j as SolanaWalletConnector, U as User, J as ConnectWalletModalOptions, K as LoginModalOptions, C as CreateWalletOptions, W as Wallet, N as SetWalletRecoveryOptions, f as SignMessageModalUIOptions, Q as SignTypedDataParams, M as MfaMethod, T as UnsignedTransactionRequest, e as SendTransactionModalUIOptions, V as FundWalletConfig, X as ConnectedWallet, O as OAuthTokens, Y as CrossAppProviderDetails, Z as MoonpaySignRequest, _ as MoonpaySignResponse, $ as SiwsMessageType, L as LoginMethod, a0 as ExternalWalletMetadata, a1 as TelegramAuthResult, a2 as TelegramWebAppData, a3 as OAuthUserInfo, a4 as OAuthFlowState, a5 as LoginWithCode, a6 as OtpFlowState, a7 as PasskeyFlowState, a8 as SiweFlowState, a as LinkedAccountWithMetadata, a9 as BridgeProviders, aa as FundingResult, ab as BaseAccountSdkType, ac as UnsignedTransactionRequestWithChainId, ad as BaseConnectedWalletType, b as BaseConnectedSolanaWallet, ae as SignerInput, af as TelegramAuthFlowState } from './types-DGtFUGql.js';
export { ag as Apple, ah as AppleOAuthWithMetadata, ai as ContractUIOptions, aj as CrossAppAccount, ak as CrossAppAccountWithMetadata, al as Discord, am as DiscordOAuthWithMetadata, an as Email, ao as EmailWithMetadata, ap as Farcaster, aq as FarcasterWithMetadata, ar as FundingStatus, as as Github, at as GithubOAuthWithMetadata, au as Google, av as GoogleOAuthWithMetadata, aw as Line, ax as LineOAuthWithMetadata, ay as LinkedAccountType, az as LinkedIn, aA as LinkedInOAuthWithMetadata, aB as LoginMethodOrderOption, aC as MessageTypes, aD as MoonpayCurrencyCode, aE as MoonpayPaymentMethod, aF as NativeFundingConfig, aG as NonEmptyArray, aH as Passkey, aI as PasskeyWithMetadata, aJ as Phone, aK as PhoneWithMetadata, aL as PriceDisplayOptions, P as PrivyErrorCode, aM as PrivyI18nStrings, aN as Quantity, aO as SiwsFlowState, aP as SmartWallet, aQ as Telegram, aR as TelegramWithMetadata, aS as Tiktok, aT as TiktokOAuthWithMetadata, aU as TransactionLog, aV as TransactionReceipt, aW as TransactionUIOptions, aX as Twitter, aY as TwitterOAuthWithMetadata, aZ as TypedMessage, a_ as WalletWithMetadata, a$ as createCrossTabUserSyncPlugin, b0 as createWalletCreationOnLoginPlugin, b1 as dataSuffix } from './types-DGtFUGql.js';
...
import { FirstClassChainType, PasskeyAuthenticateInput, OAuthProviderID, SmartWalletType, CustomOAuthProviderID, User as User$1, CoinbaseOnRampInitInput, CoinbaseOnRampInitResponse, CoinbaseOnRampStatusResponse, TransactionScanningRequestBody, TransactionScanningResponseBody, FiatOnrampEnvironment } from '@privy-io/api-types';
...
import { P as PrivyEvents } from './events-context-C317AaBW.js';
export { C as CallbackError } from './events-context-C317AaBW.js';
...
type FarcasterSignerInitRequestDataType = {
    ...
    accessToken: string;
    mfaCode: string | PasskeyAuthenticateInput['authenticator_response'] | null;
...
/** Supported fiat currencies for bank deposit funding flows. */
type BankDepositSupportedFiatCurrency = 'usd' | 'eur' | 'mxn' | 'brl' | 'gbp';
/** Supported fiat currencies for onramp funding flows. */
type SupportedFiatCurrency = BankDepositSupportedFiatCurrency | 'cny' | 'jpy' | 'inr' | 'cad' | 'krw' | 'aud' | 'idr' | 'sar' | 'try' | 'chf' | 'twd' | 'sek' | 'ngn' | 'pln' | 'ars' | 'aed' | 'thb' | 'zar' | 'dkk' | 'egp' | 'myr' | 'sgd' | 'cop' | 'php' | 'clp' | 'bdt' | 'vnd' | 'czk' | 'ils' | 'hkd' | 'nzd' | 'pkr' | 'ron' | 'kzt' | 'nok' | 'huf' | 'uah' | 'kwd' | 'qar' | 'etb' | 'mad' | 'bgn' | 'kes' | 'npr';
 ...
 *
 */
declare const PrivyProvider: ({ config, ...props }: PrivyProviderProps) => React.JSX.Element;
...
declare class ConnectorManager extends EventEmitter<ConnectorManagerEvents> {
    ...
    /**
     * Promise that resolves when Ethereum WalletConnect initialization completes.
     * Used to serialize WalletConnect initialization (Ethereum before Solana) to prevent
     * the "WalletConnect Core already initialized" race condition that causes session loss.
     */
    private ethereumWalletConnectInitPromise;
     ...
     */
    private initEthereumWalletConnect;
...
interface PrivyInterface {
    ...
    /**
     * @deprecated Use the `useUnlinkEmail` hook instead.
     *
    ...
    /**
     * @deprecated Use the `useUnlinkPhone` hook instead.
     *
    ...
    /**
     * @deprecated Use the `useUnlinkWallet` hook instead.
     *
    ...
    /**
     * @deprecated Use the `useUnlinkOAuth` hook instead.
     *
    ...
    /**
     * @deprecated Use the `useUnlinkFarcaster` hook instead.
     *
    ...
    /**
     * @deprecated Use the `useUnlinkTelegram` hook instead.
     *
...
/**
 * Hook for accepting the app's terms and conditions and privacy policy on
 * behalf of the current user.
 *
 * Use this in whitelabel integrations where the user has accepted your terms
 * outside of the Privy modal (e.g. a custom checkbox during signup).
 *
 * @example
 * const {acceptTerms} = useAcceptTerms();
 * await acceptTerms(); // marks user.hasAcceptedTerms as true
 */
declare function useAcceptTerms(): {
    acceptTerms: () => Promise<{
        user: User;
    }>;
};
...
type UseFundWalletWithBankDepositOptions = {
    ...
    source: {
         ...
         */
        assets: BankDepositSupportedFiatCurrency[];
        /**
         * The default selected source asset.
         */
        defaultAsset?: BankDepositSupportedFiatCurrency;
        /**
         * @deprecated
         *
...
type FundResult = 
/**
 * Indicates that the user completed the provider flow but exited the Privy
 * flow before waiting for confirmation
 */
{
    status: 'submitted';
}
/**
 * Indicates that the user completed the flow and waited for confirmation
 * from the provider
 */
 | {
    status: 'confirmed';
...
type UseFiatOnrampResult = {
    fund: (opts: UseFiatOnrampFundOptions) => Promise<FundResult>;
};
/**
 * @experimental This interface may change at any time
 *
 * Hook to trigger a fiat onramp funding flow.
 *
 * @returns a function that triggers the flow
 */
declare const useFiatOnramp: () => UseFiatOnrampResult;
...
/** Options for identifying a cross-app embedded wallet. */
type CrossAppWalletOptions = {
    /** The address of the embedded wallet from the linked Privy app. */
    address: string;
    /** The chain ID. Required for smart wallet signatures. */
    chainId?: number;
};
/** Options for identifying a cross-app embedded wallet for transactions. */
type CrossAppTransactionOptions = {
    /** The address of the embedded wallet from the linked Privy app. */
    address: string;
};
/**
 * Interface returned by the {@link useCrossAppAccounts} hook. Provides methods
 * to authenticate, link, unlink, and transact with cross-app accounts.
 */
interface UseCrossAppAccountsInterface {
    /**
     * Prompts an unauthenticated user to log into their account from another Privy app.
     * Once logged in, you can request signatures and transactions from their embedded wallet
     * in the linked app.
     *
     * @param options - Login options.
     * @param options.appId - The target Privy app ID to log into.
     * @returns A Promise resolving to the authenticated {@link User}.
     */
    loginWithCrossAppAccount: (options: {
        appId: string;
    }) => Promise<User>;
    /**
     * Prompts an authenticated user to link their account from another Privy app.
     * Once linked, you can request signatures and transactions from their embedded wallet
     * in the linked app.
     *
     * @param options - Link options.
     * @param options.appId - The target Privy app ID to link from.
     * @returns A Promise resolving to the updated {@link User}.
     */
    linkCrossAppAccount: (options: {
        appId: string;
    }) => Promise<User>;
    /**
     * Unlinks a cross-app account from the current user. The user must have at least
     * one other linked account.
     *
     * @param options - Unlink options.
     * @param options.subject - The OAuth subject ID of the cross-app account to unlink.
     * @returns A Promise resolving to the updated {@link User}.
     */
    unlinkCrossAppAccount: (options: {
        subject: string;
    }) => Promise<User>;
    /**
     * Signs a message with a cross-app embedded wallet. Opens a popup on the provider
     * app where the user approves the signature.
     *
     * @param message - The message to sign.
     * @param options - Wallet identification options.
     * @returns A Promise resolving to the hex-encoded signature.
     */
    signMessage: (message: string, options: CrossAppWalletOptions) => Promise<string>;
    /**
     * Signs EIP-712 typed data with a cross-app embedded wallet. Opens a popup on the
     * provider app where the user approves the signature.
     *
     * @param data - The typed data payload conforming to EIP-712.
     * @param options - Wallet identification options.
     * @returns A Promise resolving to the hex-encoded signature.
     */
    signTypedData: (data: SignTypedDataParams, options: CrossAppWalletOptions) => Promise<string>;
    /**
     * Sends a transaction with a cross-app embedded wallet. Opens a popup on the
     * provider app where the user approves the transaction.
     *
     * @param tx - The unsigned transaction request. Must include `chainId`.
     * @param options - Wallet identification options.
     * @returns A Promise resolving to the transaction hash.
     */
    sendTransaction: (tx: UnsignedTransactionRequestWithChainId, options: CrossAppTransactionOptions) => Promise<string>;
    /**
     * Signs a transaction without broadcasting it, using a cross-app embedded wallet.
     * Opens a popup on the provider app where the user approves the signature.
     *
     * @param tx - The unsigned transaction request. Must include `chainId`.
     * @param options - Wallet identification options.
     * @returns A Promise resolving to the signed transaction.
     */
    signTransaction: (tx: UnsignedTransactionRequestWithChainId, options: CrossAppTransactionOptions) => Promise<string>;
}
/**
 * Hook to authenticate, link, and transact with cross-app accounts from a provider Privy app.
 *
 * @returns Methods for cross-app account login, linking, unlinking, and wallet operations.
 */
...
interface UseUnlinkOAuthInterface {
    /**
     ...
     * and custom OAuth providers (e.g. `'custom:my-provider'`).
     *
     * Note that you can only unlink an account if the user has at least one other linked account.
     *
     * @param opts.provider {@link OAuthProviderType} the OAuth provider to unlink
     * @param opts.subject {string} the provider's subject ID for the account to unlink
     *
     * @returns Promise for the {@link User} object after the account has been unlinked
     */
    unlink: (opts: {
...
/**
 * Use this hook to unlink an OAuth account from the current user.
 *
 * Supports all OAuth providers including built-in providers (e.g. `'google'`, `'twitter'`)
 * and custom OAuth providers (e.g. `'custom:my-provider'`).
 *
 * @returns unlink - {@link UseUnlinkOAuthInterface.unlink} - unlinks an OAuth account from the user
 */
declare const useUnlinkOAuth: () => UseUnlinkOAuthInterface;

/**
 * Use this hook to unlink an email address from the current user.
 *
 * @returns unlink - unlinks an email account from the user
 */
declare const useUnlinkEmail: () => {
    unlink: ({ address }: {
        address: string;
    }) => Promise<User>;
};
...
/**
 * Use this hook to unlink a phone number from the current user.
 *
 * @returns unlink - unlinks a phone account from the user
 */
declare const useUnlinkPhone: () => {
    unlink: ({ phoneNumber }: {
        phoneNumber: string;
    }) => Promise<User>;
};
...
/**
 * Use this hook to unlink a wallet from the current user.
 *
 * Automatically detects whether the address is an Ethereum wallet (0x-prefixed) or
 * a Solana wallet and calls the appropriate unlink method.
 *
 * @returns unlink - unlinks a wallet from the user by address
 */
declare const useUnlinkWallet: () => {
    unlink: ({ address }: {
        address: string;
    }) => Promise<User>;
};
...
/**
 * Use this hook to unlink a Farcaster account from the current user.
 *
 * @returns unlink - unlinks a Farcaster account from the user
 */
declare const useUnlinkFarcaster: () => {
    unlink: ({ fid }: {
        fid: number;
    }) => Promise<User>;
};
...
/**
 * Use this hook to unlink a Telegram account from the current user.
 *
 * @returns unlink - unlinks a Telegram account from the user
 */
declare const useUnlinkTelegram: () => {
...
/**
 * Use this hook to unlink a passkey from the current user.
 *
 * If the app is configured with `shouldUnenrollMfaOnUnlink`, the passkey will also
 * be removed as an MFA method.
 *
 * @returns unlink - unlinks a passkey account from the user
 */
declare const useUnlinkPasskey: () => {
    unlink: ({ credentialId }: {
        credentialId: string;
    }) => Promise<User>;
};
...
declare const useActiveWallet: () => {
    ...
    wallet: ConnectedWallet | BaseConnectedSolanaWallet | undefined;
...
export { BaseConnectedWalletType, Captcha, ConnectWalletModalOptions, ConnectedWallet, ConnectorManager, EIP1193Provider, EthereumWalletConnector, FundWalletConfig, FundingResult, LinkedAccountWithMetadata, LoginModal, LoginModalOptions, LoginWithCode, MfaMethod, OAuthFlowState, OAuthTokens, OtpFlowState, PasskeyFlowState, PrivyClient, PrivyClientConfig, PrivyEvents, PrivyModal, PrivyProvider, SendTransactionModalUIOptions, SignMessageModalUIOptions, SignTypedDataParams, SiweFlowState, TelegramAuthFlowState, UnsignedTransactionRequest, User, VERSION, Wallet, WalletConnector, WalletListEntry, errorIndicatesMaxMfaRetries, errorIndicatesMfaTimeout, errorIndicatesMfaVerificationFailed, getCustomerAccessToken as getAccessToken, getEmbeddedConnectedWallet, getIdentityToken, toViemAccount, useAcceptTerms, useActiveWallet, useAuthMfa, useAuthMfaEnrollment, useAuthorizationSignature, useBaseAccountSdk, useConnectBaseAccount, useConnectCoinbaseSmartWallet, useConnectOrCreateWallet, useConnectWallet, useCreateWallet, useCrossAppAccounts, useCustomAuth, useDelegatedActions, useExportWallet, useFarcasterSigner, useFiatOnramp, useFundWallet, useFundWalletWithBankDeposit, useGetAccessTokenForProvider, useGetWalletPrivateKey, useGuestAccounts, useHeadlessDelegatedActions, useIdentityToken, useImportWallet, useLinkAccount, useLinkJwtAccount, useLinkWithPasskey, useLinkWithSiwe, useLinkWithSiws, useLogin, useLoginWithEmail, useLoginWithFarcasterV2, useLoginWithOAuth, useLoginWithPasskey, useLoginWithSiwe, useLoginWithSiws, useLoginWithSms, useLoginWithTelegram, useLogout, useMfa, useMfaEnrollment, useMigrateWallets, useModalStatus, useOAuthTokens, usePrivy, useRecoverEmbeddedWallet, useRegisterMfaListener, useSendTransaction, useSessionSigners, useSetWalletRecovery, useSign7702Authorization, useSignMessage, useSignTransaction, useSignTypedData, useSigners, useSignupWithPasskey, useSubscribeToJwtAuthWithFlag, useSyncJwtBasedAuthState, useToken, useUnlinkEmail, useUnlinkFarcaster, useUnlinkOAuth, useUnlinkPasskey, useUnlinkPhone, useUnlinkTelegram, useUnlinkWallet, useUpdateAccount, useUpdateEmail, useUser, useWallets, useX402Fetch };
export type { CrossAppTransactionOptions, CrossAppWalletOptions, CustomAuthFlowState, EncryptedWalletKey, JwtAuthFlowState, PrivyInterface, PrivyProviderProps, SendCodeToEmail, SendCodeToSms, UseAuthorizationSignatureInterface, UseBaseAccountSdkInterface, UseConnectBaseAccountInterface, UseConnectCoinbaseSmartWalletInterface, UseCrossAppAccountsInterface, UseCustomAuth, UseDelegatedActionsInterface, UseFundWalletInterface, UseGetAccessTokenForProvider, UseGetWalletPrivateKeyInterface, UseImportWalletInterface, UseLinkJwtAccount, UseLinkWithPasskey, UseLinkWithSiws, UseLoginWithEmail, UseLoginWithPasskey, UseLoginWithSiws, UseLoginWithSms, UseLoginWithTelegram, UseOAuthTokens, UseRecoverEmbeddedWalletInterface, UseSessionSignersInterface, UseSignersInterface, UseSignupWithPasskey, UseSubscribeToJwtAuthWithFlagInput, UseSyncJwtBasedAuthStateInput, UseSyncJwtBasedAuthStateInterface, UseUnlinkOAuthInterface, UseWalletsInterface, UseX402Fetch, WrapFetchWithPayment };
