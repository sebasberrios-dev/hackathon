...
import { CustomOAuthProviderID, OAuthProviderID, WalletChainType, SmartWalletType, User as User$1, AppResponse, PasskeyAuthenticateInput, OnrampProvider } from '@privy-io/api-types';
import { ConnectedStandardSolanaWallet, CountryCode, Chain, ChainLikeWithId, RpcConfig } from '@privy-io/js-sdk-core';
...
type CrossTabRefreshLockCallbacks<T> = {
    onLeader: () => Promise<T>;
    onFollowerReleased: () => Promise<T>;
};
type CrossTabRefreshLock = {
    withRefreshLock: <T>(callbacks: CrossTabRefreshLockCallbacks<T>) => Promise<T>;
};
...
type CrossTabUserSyncPlugin = {
    ...
    withRefreshLock: CrossTabRefreshLock['withRefreshLock'];
};
/**
...
type DataSuffixPlugin = {
    ...
    /** The normalized suffix value with 0x prefix. */
    readonly suffix: Hex;
    /**
...
/**
 * Plugin that provides default Privy-hosted Solana RPC endpoints.
 *
 * When registered, chains without user-configured RPCs fall back
 * to these defaults instead of returning null.
 */
type DefaultSolanaRpcsPlugin = {
    readonly id: symbol;
    getDefaultRpcs: ({ appId }: {
        appId: string;
    }) => Partial<Record<SolanaChain, {
        rpc: Rpc<SolanaRpcApi>;
        rpcSubscriptions: RpcSubscriptions<SolanaRpcSubscriptionsApi>;
        blockExplorerUrl: string;
    }>>;
};
declare function defaultSolanaRpcsPlugin(): DefaultSolanaRpcsPlugin;
...
type MfaSubmitArgs = {
    mfaMethod: MfaMethod;
    mfaCode: string | PasskeyAuthenticateInput['authenticator_response'];
    relyingParty: string;
};
...
interface PrivyClientConfig {
    ...
    appearance?: {
        ...
        /**
         * Sender domain text shown on the email verification screen.
         *
         * This is presentation-only and does not affect the actual email sender.
         *
         * Defaults to `privy.io`.
         */
        emailDomain?: string;
        /**
     ...
     * ```
     */
    plugins?: Array<DataSuffixPlugin | CrossTabUserSyncPlugin | WalletCreationFilterPlugin | DefaultSolanaRpcsPlugin>;
    /**
...
type AppConfig = {
    ...
    appearance: {
        ...
        emailDomain?: NonNullable<PrivyClientConfig['appearance']>['emailDomain'];
...
export { PrivyErrorCode as P, createCrossTabUserSyncPlugin as a$, createWalletCreationOnLoginPlugin as b0, createDataSuffixPlugin as b1, SolanaWalletConnector as j, defaultSolanaRpcsPlugin as k, toSolanaWalletConnectors as t, WalletConnector as u, PrivyProxyProvider as v };
export type { SiwsMessageType as $, WalletListEntry as A, BaseConnectedEthereumWallet as B, CreateWalletOptions as C, AppConfig as D, EthereumRpcRequestType as E, FundingMethod as F, BaseConnectedWallet as G, HDWalletWithMetadata as H, ConnectorType as I, ConnectWalletModalOptions as J, LoginModalOptions as K, LoginMethod as L, MfaMethod as M, SetWalletRecoveryOptions as N, OAuthTokens as O, SignTypedDataParams as Q, RuntimeLoginOverridableOptions as R, SolanaChain as S, UnsignedTransactionRequest as T, User as U, FundWalletConfig as V, Wallet as W, ConnectedWallet as X, CrossAppProviderDetails as Y, MoonpaySignRequest as Z, MoonpaySignResponse as _, LinkedAccountWithMetadata as a, ExternalWalletMetadata as a0, TelegramAuthResult as a1, TelegramWebAppData as a2, OAuthUserInfo as a3, OAuthFlowState as a4, LoginWithCode as a5, OtpFlowState as a6, PasskeyFlowState as a7, SiweFlowState as a8, BridgeProviders as a9, LinkedInOAuthWithMetadata as aA, LoginMethodOrderOption as aB, MessageTypes as aC, MoonpayCurrencyCode as aD, MoonpayPaymentMethod as aE, NativeFundingConfig as aF, NonEmptyArray as aG, Passkey as aH, PasskeyWithMetadata as aI, Phone as aJ, PhoneWithMetadata as aK, PriceDisplayOptions as aL, PrivyI18nStrings as aM, Quantity as aN, SiwsFlowState as aO, SmartWallet as aP, Telegram as aQ, TelegramWithMetadata as aR, Tiktok as aS, TiktokOAuthWithMetadata as aT, TransactionLog as aU, TransactionReceipt as aV, TransactionUIOptions as aW, Twitter as aX, TwitterOAuthWithMetadata as aY, TypedMessage as aZ, WalletWithMetadata as a_, FundingResult as aa, BaseAccountSdkType as ab, UnsignedTransactionRequestWithChainId as ac, BaseConnectedWalletType as ad, SignerInput as ae, TelegramAuthFlowState as af, Apple as ag, AppleOAuthWithMetadata as ah, ContractUIOptions as ai, CrossAppAccount as aj, CrossAppAccountWithMetadata as ak, Discord as al, DiscordOAuthWithMetadata as am, Email as an, EmailWithMetadata as ao, Farcaster as ap, FarcasterWithMetadata as aq, FundingStatus as ar, Github as as, GithubOAuthWithMetadata as at, Google as au, GoogleOAuthWithMetadata as av, Line as aw, LineOAuthWithMetadata as ax, LinkedAccountType as ay, LinkedIn as az, BaseConnectedSolanaWallet as b, UserRecoveryMethod as c, LoginToMiniApp as d, SendTransactionModalUIOptions as e, SignMessageModalUIOptions as f, SessionSignerInput as g, SolanaStandardWallet as h, SolanaFundingConfig as i, MfaSubmitArgs as l, SolanaRpcRequestType as m, EthereumRpcResponseType as n, SolanaRpcResponseType as o, PrivyFarcasterSignerInitResponse as p, EIP1193Provider as q, EntropyIdVerifier as r, RequestArguments as s, WalletClientType as w, ConnectedWalletMetadata as x, PrivyClientConfig as y, SetBaseAccountSdkType as z };
